...
public class BinaryAdditionProgram implements Program {

    Integer startPos = 1;
    Integer memoryAlloc = 32;
    ...
    public String output(String input) throws Exception {
        ...
        String filePath = "./src/main/java/xyz/devmeko/TuringMachine/Programs/BinaryAddition.jff";
        ...
        return result.substring(result.indexOf('e') + 1);
    }
}
